...
namespace Salmpled.Migrations
{
    ...
    [Migration("20211111060803_InitialCreate8")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Salmpled.Models.SampleFolderGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("FolderGroupName")
            ...
            modelBuilder.Entity("Salmpled.Models.SampleSamplePlaylistFolderGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SampleSamplePlaylistFolderGroup");
                });
            ...
            modelBuilder.Entity("Salmpled.Models.Sample", b =>
                {
                    b.HasOne("Salmpled.Models.SampleFolderGroup", "FolderGroup")
                        .WithMany("Samples")
                        .HasForeignKey("FolderGroupId")
            ...
            modelBuilder.Entity("Salmpled.Models.SampleSamplePlaylist", b =>
                {
                    b.HasOne("Salmpled.Models.SampleSamplePlaylistFolderGroup", "FolderGroup")
